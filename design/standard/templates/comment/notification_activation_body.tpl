...
{'Dear %email,'|i18n( 'extension/ezcomments/activate/email', , hash( '%email', $subscriber.email ) )} 
<br />
<br />
<p>
{'You have subscribed the comment update of content. Before you get notification on the content, you need to confirm the subscription.'|i18n( 'extension/ezcomments/activate/email' )}
 <br />
...
<p>
{'Please click the link to activate.'|i18n( 'extension/ezcomments/activate/email' )}
<a href={concat( '/comment/activate/', $subscription.hash_string )|ezurl( , 'full' )}>
    ...
    {undef $expiry_days}
<p>
    {'If you don\'t want to receive the subscription email, igore this email.'|i18n( 'extension/ezcomments/activate/email' )}
</p>
<p>
