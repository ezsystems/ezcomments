...
{include name="view_page" uri="design:comment/ajax/view_page.tpl"}
{include name="view_comment_list" uri="design:comment/ajax/view_comment_list.tpl"}
{if $enabled|eq(1)}
{include name="view_addcomment" uri="design:comment/ajax/view_add_comment.tpl"}
{else}
