...
{if $objectattribute.data_float}
    ...
    {if $can_read}
        {include name="CommentPage" contentobject=$contentobject language_id=$language_id total_count=$total_count total_page=$total_page current_page=$current_page uri="design:comment/view/page.tpl"}
